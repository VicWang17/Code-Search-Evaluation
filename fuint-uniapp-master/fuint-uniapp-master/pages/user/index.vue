    ...
    <view class="main-header">
      ...
      <view class="user-info">
        ...
        <view class="user-content" @click="onUserInfo">
          ...
          <!-- 添加升级会员链接 -->
          <view v-if="isLogin" class="upgrade-member" @click="onUpgradeMember">
...
<script>
  ...
  const service = [
    ...
    { id: 'pointExchange', name: '积分兑换', icon: 'jifen', type: 'link', url: 'pages/points/exchange' },
  ...
  export default {
    ...
    methods: {
      ...
      // 添加会员升级方法
      onUpgradeMember() {
        // 这里是mock函数，后续可以替换为实际接口调用
        this.$toast('会员升级功能正在开发中...')
        // 可以在这里添加实际的接口调用
        // 例如导航到会员升级页面
        // this.$navTo('pages/user/upgrade')
      }
    },
